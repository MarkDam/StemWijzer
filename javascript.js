...
},
{
	...
	parties: [
	{name: "PvdA", position: "pro", explanation: "Die kleine groep mensen in Nederland die meer dan â‚¬150.000 per jaar verdient, vragen we een extra bijdrage te leveren. Dat geld wil de PvdA gebruiken voor betere ouderenzorg."},
	{name: "SP", position: "pro", explanation: "De afgelopen jaren zijn de verschillen in inkomen en vermogen tussen de rijkste Nederlanders en de rest weer verder toegenomen. De rijken werden rijker, terwijl grote groepen Nederlanders er helemaal niet op vooruit gingen of zelfs achteruit. Het is redelijk een extra bijdrage van deze rijkste groep te vragen."},
	{name: "GroenLinks", position: "pro", explanation: "Al 30 jaar groeit de inkomensongelijkheid: lage en middeninkomens stijgen nauwelijks maar topinkomens wel. Als we onze welvaart eerlijk delen, gaat iedereen erop vooruit. GroenLinks vraagt meer van topinkomens; zo kunnen de belastingen voor lage en middeninkomens flink naar beneden."},
	{name: "Partij voor de Dieren", position: "pro", explanation: "De Partij voor de Dieren vindt dat de sterkste schouders de zwaarste lasten moeten dragen. Echter zeker zo belangrijk is een beter belastingstelsel, waarin het gebruik van grondstoffen meer belast wordt en arbeid wordt verlaagd. Zo creÃ«ren we werkgelegenheid en maken we de samenleving duurzamer."},
	{name: "DENK", position: "pro", explanation: "DENK staat voor het eerlijk verdelen van de lasten. Daarom vraagt DENK van mensen met een hoger inkomen een grotere bijdrage, zodat wij mensen met een kleinere portemonnee kunnen steunen. "},
	{name: "De Burger Beweging", position: "pro", explanation: "Eens, de speciale fiscale voordelen voor de hoogste inkomensgroepen waardoor zij nu (bijna) geen belasting betalen moet worden afgeschaft (dit geldt ook voor de koninklijke familie)."},
	{name: "Vrijzinnige Partij", position: "pro", explanation: "De Vrijzinnige Partij gaat uit van gelijkwaardigheid van mensen. Iedereen is vrij om zo veel mogelijk geld te verdienen. Maar het is de samenleving die dat mogelijk maakt. Dan is een progressief belastingstelsel het eerlijkst. De Vrijzinnige Partij stelt een nieuw toptarief van 65 % voor voor inkomens boven de â‚¬ 229.001"},
	{name: "Artikel 1", position: "pro", explanation: "Er is in Nederland veel ongelijkheid. De belastingen zijn een manier om die kleiner te maken en zo de gelijkwaardigheid en eenheid te bevorderen."},
	{name: "50Plus", position: "ambivalent", explanation: "50PLUS vindt dat de sterkste schouders de zwaarste lasten moeten dragen. DÃ¡t is en blijft ons uitgangspunt. Meer belasting voor de hoogste inkomensgroepen kan aan de orde zijn, als dat per saldo inkomensverschillen ook echt kleiner maakt Ã©n ook hogere maatschappelijke welvaart oplevert. "},
	{name: "VVD", position: "contra", explanation: "De VVD wil de inkomstenbelasting voor iedereen verlagen. Ongeacht wat je verdient. Zodat werken meer gaat lonen en je meer geld overhoudt in je portemonnee. "},
	{name: "PVV", position: "contra", explanation: "Geen toelichting gegeven"},
	{name: "CDA", position: "contra", explanation: "In Nederland begint het hoogste belastingtarief bij een veel lager inkomen dan in andere landen. Om werken weer te laten lonen, moet de belasting op arbeid juist omlaag. De hoogste inkomens betalen in ons belastingvoorstel wel een solidariteitsbijdrage (hoger belastingtarief), maar die is niet hoger dan de huidige belastingtarieven."},
	{name: "D66", position: "contra", explanation: "D66 wil de belasting juist verlagen zodat mensen meer overhouden van hun inkomen. Dit wordt gedaan door het verlagen van de belasting voor lage en middeninkomens, maar iedereen mag na jaren van crisis profiteren van een belastingverlaging. Door de belasting te verlagen, loont werken voor iedereen."},
	{name: "ChristenUnie", position: "contra", explanation: "De ChristenUnie hervormt het belastingstelsel. Voor iedereen gaan de belastingen per saldo omlaag. Sommige groepen, zoals eenverdieners betalen onrechtvaardig veel belasting. Dat wil de ChristenUnie veranderen. Met name de middeninkomens gaan erop vooruit."},
	{name: "SGP", position: "contra", explanation: "De SGP wil dat de lasten op arbeid worden verlaagd door het introduceren van Ã©Ã©n laag, uniform basistarief en een toptarief: de zogenoemde sociale vlaktaks. De hoogste inkomensgroepen moeten daarbij zeker niet nog meer belasting gaan betalen dan ze nu al doen. "},
	{name: "OndernemersPartij", position: "contra", explanation: "De nivellering onder de inkomensbelasting is ver genoeg doorgevoerd."},
	{name: "VNL", position: "contra", explanation: "Werken moet lonen. Het is onjuist om mensen te straffen naarmate ze meer gaan verdienen. Lage belastingen betekent ook dat de koopkracht toeneemt en de economie harder groeit."},
	{name: "Nieuwe Wegen", position: "contra", explanation: "In Nederland is de inkomensongelijkheid gelukkig klein. Dat moet zo blijven. Als je wat meer gaat verdienen, moet je het niet meteen kwijt zijn aan hogere belastingen. Als we zuiniger met ons belastinggeld omgaan, strijden tegen belastingontduiking, minder geld kwijt zijn aan verspilling en bureaucratie bv. in de zorg dan zijn belastingverhogingen voor gewone mensen niet nodig."},
	{name: "Forum voor Democratie", position: "contra", explanation: "De belastingen moeten over de hele linie omlaag, vooral voor de minst verdienenden door invoering van een belastingvrije voet van â‚¬20.000 voor iedereen. De economische dynamiek moet terug in Nederland."},
	{name: "Piratenpartij", position: "contra", explanation: "De Piratenpartij wil het belastingstelsel zo hervormen, dat reÃ«le productie gestimuleerd wordt. Wij willen multinationals aanpakken en het verbruik van grondstoffen meer belasten."},
	{name: "Libertarische Partij", position: "contra", explanation: "De hoogste inkomensgroepen betalen al het leeuwendeel van de opbrengsten van de inkomstenbelasting. Belasting moet juist voor alle inkomensgroepen omlaag. De LP pleit voor een belastingvrije voet van â‚¬20.000 voor alle werknemers en daarna een vlaktaks van 15,6%. "},
	{name: "Lokaal in de Kamer", position: "contra", explanation: "Deze inkomensgroep betaalt al een hoger tarief, terwijl zij van weinig tot geen extra voordelen gebruik kan maken. "}
	]
},
{
	...
	parties: [
	{name: "VVD", position: "pro", explanation: "Soms kan een werkgever je geen vast contract geven, terwijl je wel wil blijven werken. In dat gevoel moet je niet gedwongen worden om ontslagen te worden, maar helpt het juist als je een extra tijdelijk contract kan krijgen. Want dan kan je tenminste blijven werken."},
	{name: "CDA", position: "pro", explanation: "Er moet meer ruimte komen voor meerjarige tijdelijke contracten. Hierdoor ontstaat voor de werknemer meer zekerheid en bescherming waar nu een groot gebrek aan is. Daardoor hoeven werkgevers ook minder gebruik te maken van alleen maar flexibel personeel."},
	{name: "D66", position: "pro", explanation: "D66 vindt de tweedeling tussen mensen met een vast en flexibel dienstverband onwenselijk. Vooral jongeren en lager opgeleiden hebben steeds vaker een tijdelijk contract. D66 wil voorkomen dat zij na twee jaar worden ontslagen, omdat de werkgever het niet aandurft hen een vast contract te geven."},
	{name: "ChristenUnie", position: "pro", explanation: "De ChristenUnie wil dat flexibele contracten meer zekerheid bieden. Tijdelijke contracten bij eenzelfde werkgever moeten in duur oplopen. Contracten langer dan twee jaar moeten mogelijk zijn, maar het uitgangspunt is vast. Daarom wordt het goedkoper en makkelijker om mensen in vaste dienst te nemen."},
	{name: "GroenLinks", position: "pro", explanation: "De Wet Werk en Zekerheid van minister Asscher die flexibilisering van de arbeidsmarkt moest tegen te gaan, werkt niet: mensen staan nu na twee jaar op straat. GroenLinks wil dit probleem oplossen door flexibel werk duurder te maken dan vast en een tweede, meerjarig contract mogelijk te maken."},
	{name: "SGP", position: "pro", explanation: "De SGP vindt de huidige regeling voor opvolgende tijdelijke contracten te strikt. Om te voorkomen dat te makkelijk gebruik gemaakt wordt van tijdelijke contracten moeten vooral vaste contracten aantrekkelijker gemaakt worden."},
	{name: "Partij voor de Dieren", position: "pro", explanation: "De PvdD vindt het belangrijk dat beginnende werknemers een grote mate van zekerheid wordt geven om zo de relatie tussen werknemer en werkgever stabieler en duurzaam te maken. Dan loont het ook voor de werkgever en werknemer om te investeren in elkaar (trainingen en scholing)."},
	{name: "OndernemersPartij", position: "pro", explanation: "Dit is goed voor ZZPÂ´ers"},
	{name: "VNL", position: "pro", explanation: "De duur van een arbeidsovereenkomst is in principe een zaak tussen werkgever en werknemer. Nu zien we dat werknemers vaak het slachtoffer worden van ontslag omdat de werkgever geen tijdelijk arbeidscontract mag afsluiten voor een periode langer dan twee jaar. "},
	{name: "DENK", position: "pro", explanation: "DENK wil dat mensen meer zekerheid hebben op de arbeidsmarkt. Het gedwongen uit de baan vliegen omdat iemand drie korte tijdelijke contracten heeft gehad leidt tot draaideurwerknemers. Daarom moet het mogelijk zijn om tijdelijke contracten voor een langere periode af te sluiten. "},
	{name: "Forum voor Democratie", position: "pro", explanation: "De flex-wet van Asscher (PvdA) werkt in de praktijk totaal averechts en vergroot de werkloosheid, deze dient afgeschaft te worden."},
	{name: "De Burger Beweging", position: "pro", explanation: "Eens. "},
	{name: "Vrijzinnige Partij", position: "pro", explanation: "Met de invoering van het basisinkomen kan de arbeidsmarkt vernieuwd worden. Flexibilisering met de zekerheid van een basisinkomen is het streven van de Vrijzinnige Partij. Dan is onnodig betuttelend om uit te gaan van een maximum van 2 jaar voor meerdere tijdelijke contracten. Ook geeft de regel nu door de versoepeling van het ontslagrecht de suggestie alsof een contract voor onbepaalde tijd zekerheid biedt. Dat is slechts schijnzekerheid als mensen toch ontslagen kunnen worden."},
	{name: "Libertarische Partij", position: "pro", explanation: "Werkgever en werknemer moeten vrij zijn om de voorwaarden vast te leggen waarbinnen er gewerkt wordt. Dit kan op individueel niveau of in CAO verband. Dit doet niet af aan de waarde die individuele werknemers met een vast dienstverband voor een werkgever hebben. De beslissingen dienen bij de direct betrokkenen te liggen."},
	{name: "Lokaal in de Kamer", position: "pro", explanation: "Dit geeft meer mogelijkheden voor werkgevers, terwijl werknemers ook voor langere tijd zekerheid hebben. "},
	{name: "PvdA", position: "contra", explanation: "De PvdA is hier faliekant op tegen. Een vast contract is voor ons de norm. Sommige partijen willen zo lang mogelijk tijdelijke contracten geven omdat werkgevers daarmee mensen makkelijk kunnen ontslaan. Dergelijke langdurige onzekerheid knaagt aan mensen en zorgt ervoor dat je bijvoorbeeld geen huis kunt kopen."},
	{name: "PVV", position: "contra", explanation: "Geen toelichting gegeven"},
	{name: "SP", position: "contra", explanation: "We moeten het aantal tijdelijke contracten niet uitbreiden, maar terugdringen. Werknemers hebben behoefte aan zekerheid. Door bijvoorbeeld de WW-premie voor tijdelijke contracten te verhogen en voor vaste contracten verlagen maken we vast werk aantrekkelijker voor werkgevers."},
	{name: "50Plus", position: "contra", explanation: "50PLUS ziet tijdelijke contracten vooral als een opmaat naar een vast contract. Het verschil (arbeidsvoorwaardelijk) tussen tijdelijke, flexibele en vaste banen moet minder groot worden. Op die wijze zullen bedrijven meer vaste contracten aan gaan bieden met als voordeel voor de werknemer: meer zekerheid en bijvoorbeeld mogelijkheden op de woningmarkt."},
	{name: "Nieuwe Wegen", position: "contra", explanation: "Mensen hebben recht en behoefte aan zekerheid. We zijn in Nederland kampioen 'flexbaantjes'. Dat moet stoppen. Met vaste banen kunnen jongeren bouwen aan hun toekomst en weten werknemers en werkgevers waar ze aan toe zijn. Vaste banen zijn goed voor de economie en vergroten de loyaliteit van werknemers aan hun bedrijf en werkgever. Daarom moet er een nieuw sociaal akkoord komen dat gedragen wordt door het midden- en kleinbedrijf met duidelijke afspraken oa. over vaste arbeidscontracten."},
	{name: "Piratenpartij", position: "contra", explanation: "De Piratenpartij wil schijnzelfstandigheid voorkomen. Door de wildgroei aan tijdelijke contracten is de onderhandelingspositie en de baanzekerheid van werknemers ernstig verzwakt. De Piratenpartij wil deze ontwikkeling een halt toeroepen en de positie van werknemers versterken. Een arbeidscontract van langer dan twee jaar is niet tijdelijk te noemen, maar vast, en zou dus met een vast contract moeten worden ingevuld."},
	{name: "Artikel 1", position: "contra", explanation: "Artikel 1 wil de onzekere positie van werknemers terugdringen. Schijnzelfstandigheid dient te worden voorkomen."}
	]
},
{
	...
	parties: [
	{name: "PVV", position: "pro", explanation: "Geen toelichting gegeven"},
	{name: "SP", position: "pro", explanation: "Veel mensen met zware beroepen kunnen niet doorwerken. Ook is het voor veel jongeren en ouderen moeilijk om een baan te vinden. Daarom gaat bij de SP de AOW-leeftijd weer naar 65 jaar. Daarnaast verhogen we de AOW-uitkering met 10%."},
	{name: "Partij voor de Dieren", position: "pro", explanation: "Er zijn veel werkzoekende ouderen. Doorgaan met verhoging van de AOW-leeftijd is onverstandig. Er moet een flexibele AOW-leeftijd komen, mede gebaseerd op het aantal gewerkte jaren. Wie 40 jaar gewerkt heeft, krijgt vanaf 65 jaar AOW. Het wordt mogelijk te kiezen voor een lagere AOW-leeftijd in ruil voor een in evenredigheid aangepaste AOW-uitkering."},
	{name: "50Plus", position: "pro", explanation: "De AOW-leeftijd terugbrengen naar 65 jaar is goed voor de arbeidsmarkt. Jongere en oudere werkzoekenden krijgen dan mÃ©Ã©r kansen op de arbeidsmarkt. Juist bij ouderen is de langdurige werkloosheid vaak hardnekkig en structureel. Het terugbrengen van de AOW-leeftijd naar 65 is daarnaast goed voor mensen met zware beroepen, mensen die minder verdienen en mensen met een zwakkere gezondheid. 50PLUS: AOW-leeftijd voor iedereen terug naar 65! "},
	{name: "OndernemersPartij", position: "pro", explanation: "Dit is een onrechtvaardige bezuiniging gebleken, zonder visie."},
	{name: "De Burger Beweging", position: "pro", explanation: "Eens voor mensen die dit willen, niet verplicht voor iedereen."},
	{name: "Lokaal in de Kamer", position: "pro", explanation: "Oudere werknemers zijn relatief duur, hebben al een lang arbeidsverleden achter de rug. Het schept banen voor jeugd en verlicht lasten voor ondernemers. "},
	{name: "Piratenpartij", position: "ambivalent", explanation: "De Piratenpartij staat voor zelfbeschikking en het recht zelf deze keuze te maken. Wij vinden dus niet dat de overheid voor mensen moet beslissen wanneer zij moeten stoppen met werken. De Piratenpartij wil het basisinkomen invoeren, zodat iedereen, jong of oud, de garantie heeft om te kunnen voorzien in zijn of haar basisbehoeften. Hierdoor vervalt het hele AOW-systeem, dat leeftijdsgebonden is. Iedere persoon heeft dan dus zelf de keuze op welke leeftijd men met pensioen gaat. "},
	{name: "VVD", position: "contra", explanation: "Wij willen de AOW ook in de toekomst kunnen blijven betalen. Dat kan alleen als we langer doorwerken, want we worden steeds ouder en gezonder. Daarom hebben we ervoor gezorgd dat de AOW-leeftijd de komende jaren stap voor stap omhoog gaat. "},
	{name: "PvdA", position: "contra", explanation: "We worden gemiddeld ouder en we willen allemaal op een gegeven moment een goede oude dag. Het kan niet anders dan dat we de AOW leeftijd moeten laten stijgen. Wie echter een leven lang hard gewerkt heeft en niet meer kÃ¡n, moet eerder kunnen stoppen. Daarom moet je zelf kunnen bepalen of je eerder stopt tegen een reÃ«le en behapbare korting op de AOW. "},
	{name: "CDA", position: "contra", explanation: "Dat is onbetaalbaar, omdat mensen steeds ouder worden en iedereen meebetaalt aan de AOW. Solidariteit tussen jongeren en ouderen moet overeind blijven, je kan die lasten niet alleen bij jongeren neerleggen. Wel moeten ouderen met een klein pensioen die door het huidige kabinetsbeleid zijn gekort en geconfronteerd worden met een AOW-gat worden gecompenseerd."},
	{name: "D66", position: "contra", explanation: "De AOW houden we betaalbaar door de AOW-leeftijd te koppelen aan de levensverwachting. D66 wil het mogelijk maken eerder of later dan de AOW-leeftijd te stoppen met werken. Iemand die langer wil doorwerken of juist eerder wil stoppen, kan dat dan doen. De hoogte van de uitkering verandert mee."},
	{name: "ChristenUnie", position: "contra", explanation: "De ChristenUnie wil een eerlijk en houdbaar pensioenstelsel en een einde aan de tweedeling tussen jong en oud. Daarom is de AOW-leeftijd gekoppeld aan de levensverwachting. Ook zijn wij voor een pensioenhervorming. Die raakt niet de koopkracht van gepensioneerden, zij gaan er bij de CU op vooruit."},
	{name: "GroenLinks", position: "contra", explanation: "GroenLinks was en is voorstander van de verhoging van de AOW-leeftijd om de AOW op lange termijn betaalbaar te houden. er is een groep mensen in fysiek zware beroepen van wie het niet reÃ«el is om te vragen langer door te werken. Voor hen wil GroenLinks vervroegde uittreding mogelijk maken."},
	{name: "SGP", position: "contra", explanation: "De SGP heeft deelgenomen aan het pensioenakkoord en ingestemd met de koppeling van de AOW-leeftijd aan levensverwachting. "},
	{name: "VNL", position: "contra", explanation: "De AOW-leeftijd is sinds kort gekoppeld aan de levensverwachting. Dat betekent dat mensen die nu in de 30 zijn, pas AOW krijgen na hun 70e. Dat is onwenselijk. Daarom zetten wij de AOW-leeftijd vast op 67. Partijen die zeggen de AOW-leeftijd te verlagen naar 65, hebben hun plannen niet laten doorrekenen. "},
	{name: "DENK", position: "contra", explanation: "DENK heeft een sociaal hart, maar ons stelsel van sociale zekerheid moet wel betaalbaar blijven. De AOW-leeftijd terugbrengen naar 65 leidt tot een te grote kostenpost die voor de rekening komt van komende generaties. DENK wil komende generaties niet belasten met een grote last op de begroting. Daarom vraagt DENK aan mensen om wat langer door te werken. Dit is rechtvaardig, omdat de levensverwachting is gestegen. "},
	{name: "Nieuwe Wegen", position: "contra", explanation: "Iedereen moet na 45 jaar werken kunnen stoppen. Begin je eerder op jonge leeftijd, dan stop je eerder. Begin je op latere leeftijd dan werk je wat langer door. Zo zullen mensen met zwaar werk en die vaak lager opgeleid zijn eerder kunnen stoppen en mensen met een hogere opleiding en vaak met minder fysiek zwaar werk langer kunnen doorwerken. Op deze manier kan iedereen in goede gezondheid nog genieten van zijn of haar oude dag."},
	{name: "Forum voor Democratie", position: "contra", explanation: "FVD wil de AOW-leeftijd naar 66 jaar. En voor alle AOW-ers wil FVD ook de belastingvrije voet van â‚¬20.000 zodat het koopkrachtverlies van AOW-ers onmiddellijk wordt hersteld."},
	{name: "Vrijzinnige Partij", position: "contra", explanation: "In 1956 bij de invoering van de AOW was de levensverwachting 71 jaar en de AOW-leeftijd 65. Nu 60 jaar later is levensverwachting rond de 80 jaar. Dan is het financieel onverantwoord om aan 65 jaar vast te houden. De discussie wordt overigens overbodig door de invoering van een basisinkomen. Daarnaast kiest de Vrijzinnige Partij voor het wetsvoorstel van het Kamerlid Klein om de AOW te flexibiliseren. Mensen moeten vrij zijn om de AOW 5 jaar eerder of 5 jaar later te laten ingaan."},
	{name: "Artikel 1", position: "contra", explanation: "Nu de levensverwachting is gestegen en mensen ook gezonder oud worden is (met uitzondering van zware beroepen) is een pensioengerechtigde leeftijd niet langer nodig of financieel haalbaar voor de overheid. Bovendien pleit Artikel 1 in haar programma voor het basisinkomen of onvoorwaardelijke uitkering. Door de AOW flexibel te maken (wetsvoorstel Kamerlid Klein) kunnen mensen ervoor kiezen om 5 jaar eerder of later de AOW in te laten gaan. Hiermee vergroten we de zelfbeschikking van burgers."},
	{name: "Libertarische Partij", position: "contra", explanation: "De betaalbaarheid van de AOW staat onder grote druk de komende jaren dankzij de vergrijzing. Wie hiervoor pleit, mag ons even voorrekenen hoe ze dit willen betalen. Wij pleiten wel voor de mogelijkheid voor mensen om belastingvrij een potje aan te leggen om toch nog vervroegd met pensioen te gaan."}
	]
},
{
	...
	parties: [
	{name: "PvdA", position: "pro", explanation: "Iedereen die werkt, moet kunnen rekenen op een goede ziektekostenverzekering. Ook als je als zzp'er werkt. Maar dan moet je dat wel kunnen veroorloven. Daarom wil de PvdA alle opdrachtgevers verplichten een extra toeslag te betalen aan zzp'ers, bovenop het salaris, waarmee zzp'ers hun ziektekosten en pensioen kunnen regelen."},
	{name: "SP", position: "pro", explanation: "Op de arbeidsmarkt zie je helaas veel zzp-ers als schijnzelfstandigen. Met een verplichte verzekering bieden we hen bescherming tegen ongevallen, en voorkomen we gelijk dat zzp-constructies oneerlijk concurreren met loonwerk"},
	{name: "CDA", position: "pro", explanation: "Op die manier kan de tweedeling tussen flex en vast op de arbeidsmarkt tegengegaan worden. De verplichting voor werkgevers tot loondoorbetaling bij ziekte (nu twee jaar) kan hierdoor fors worden teruggebracht. Voor langere ziekteperiodes komt er een private regeling met publieke waarborgen. Zo blijven alle werkenden beschermd en wordt het voor werkgevers aantrekkelijker om mensen in vaste dienst te nemen."},
	{name: "ChristenUnie", position: "pro", explanation: "De ChristenUnie wil dat wie werkt verzekerd is tegen arbeidsongeschiktheid. Daarom zijn wij voor een verplichte verzekering voor zzpâ€™ers voor arbeidsongeschiktheid die een minimuminkomen garandeert. Dit verkleint de risicoâ€™s voor de zzpâ€™er en zorgt voor een gelijker speelveld op de arbeidsmarkt."},
	{name: "GroenLinks", position: "pro", explanation: "Het is belangrijk dat elke werkende in Nederland verzekerd is tegen arbeidsongeschiktheid. Daarom wil GroenLinks een collectieve, betaalbare basisvoorziening op minimumniveau. Niemand gaat er hierdoor op achteruit."},
	{name: "50Plus", position: "pro", explanation: "50PLUS vindt het verstandig om zzpâ€™ers verplicht te stellen zich te verzekeren tegen arbeidsongeschiktheid en ook verplicht pensioen op te laten bouwen. Die verplichting moet voor iedereen gelden, zodat een gelijk speelveld ontstaat voor Ã¡lle zzpâ€™ers. Dit heeft ook het voordeel dat een meer gelijk speelveld ontstaat met werknemers in loondienst die ook deze verplichte verzekerings-en pensioenkosten hebben. Hiermee kan de kloof tussen vast, tijdelijk en flexibel werk enigszins geslecht worden."},
	{name: "DENK", position: "pro", explanation: "DENK vindt het onverantwoord dat veel mensen onverzekerd deelnemen aan de arbeidsmarkt. Hierdoor lopen mensen een groot risico op inkomensverlies bij arbeidsongeschiktheid. Daarom wil DENK een verplichte verzekering voor zzp'ers, waarbij de overheid zorgt dat de verzekering betaalbaar is. "},
	{name: "Nieuwe Wegen", position: "pro", explanation: "In ons land hebben we afgesproken dat we goed verzekerd zijn tegen arbeidsongeschiktheid en ziekte. Dat willen we zo houden, ook als de arbeidsmarkt verandert. Je ziet nu al dat ZZP'ers zich niet verzekeren en voor onverantwoorde lage lonen hun werk doen, vaak voor malafide werkgevers. Met deze verzekering voorkomen we dat mensen onverzekerd arbeidsongeschikt of ziek worden en voorkomen we dat er een concurrentie op lonen komt waardoor vaste banen en eerlijke werkgevers worden weggeconcurreerd. "},
	{name: "De Burger Beweging", position: "pro", explanation: "Eens, alleen een basisverzekering, de rest moet vrije keuze blijven."},
	{name: "Artikel 1", position: "pro", explanation: "Deze groep mensen blijft nu deels verstoken van sociale zekerheid. Een collectieve verplichte verzekering is betaalbaarder en eerlijker dan stimuleren van verplichte privÃ©verzekeringen."},
	{name: "Lokaal in de Kamer", position: "pro", explanation: "Niet alle zzp'ers zijn nu in staat om een periode van minder of geen inkomsten op te vangen."},
	{name: "Vrijzinnige Partij", position: "ambivalent", explanation: "Door het Vrijzinnige Partij-plan om het onvoorwaardelijk basisinkomen in te voeren, hebben alle zelfstandig ondernemers een basiszekerheid bij ziekte of arbeidsongeschiktheid. Er hoeft dan dus geen verplichting te komen om premies te gaan betalen. \"Verplichten\" gaat ook voorbij aan de kern van vrij ondernemerschap. "},
	{name: "VVD", position: "contra", explanation: "Als je bewust kiest voor zelfstandigheid, moet je natuurlijk zo veel mogelijk ruimte krijgen. Want met minimale verplichtingen heb je maximale ruimte om te ondernemen. Als ZZPâ€™er moet je daarom zelf kunnen bepalen waarvoor en hoe je je wilt verzekeren."},
	{name: "PVV", position: "contra", explanation: "Geen toelichting gegeven"},
	{name: "D66", position: "contra", explanation: "D66 wil dat zelfstandigen zich gemakkelijker kunnen verzekeren tegen arbeidsongeschiktheid, maar wel als ze dat zelf willen. We willen dat zelfstandigen kunnen rondkomen, pensioen opbouwen en zich verzekeren; hun tarief mag niet leiden tot oneerlijke concurrentie en eigen armoede."},
	{name: "SGP", position: "contra", explanation: "De SGP vindt wel dat zzp'ers zelf een basale voorziening moeten aanleggen voor arbeidsongeschiktheid en ziekte, maar dat hoeft geen verplichte verzekering te zijn. De manier waarop zij het minimum regelen is vrij."},
	{name: "Partij voor de Dieren", position: "contra", explanation: "Het wordt voor zzpâ€™ers eenvoudiger om vrijwillig te sparen voor pensioen of zich te verzekeren. Zzpâ€™ers krijgen toegang tot een publieke arbeidsongeschiktheids- en pensioenverzekering. Zoâ€™n verzekering mag echter geen verplichtend karakter hebben."},
	{name: "OndernemersPartij", position: "contra", explanation: "De keuze behoort bij ZZPÂ´ers zelf te liggen. De overheid zou zelf een sociaal ondervang moeten regelen voor de ZZPÂ´ers."},
	{name: "VNL", position: "contra", explanation: "Ondernemers moeten zoveel mogelijk met rust gelaten worden. Geen extra verplichtingen of lastenverzwaringen. De overheid zou de belastingen omlaag moeten gooien en het ondernemerschap zoveel mogelijk moeten faciliteren."},
	{name: "Forum voor Democratie", position: "contra", explanation: "ZZP'ers moeten juist meer vrijheid krijgen en minder verplichtingen."},
	{name: "Piratenpartij", position: "contra", explanation: "De Piratenpartij kiest in haar oplossingen niet snel voor dwang en drang. Bovendien speelt dit probleem vooral bij schijnzelfstandigheid, en daar wil de Piratenpartij nu juist vanaf. 'Unieke professionals' kunnen vaak prima zelf bepalen welke risico's ze willen lopen en hoeven niet betutteld te worden. De Piratenpartij wil verzekeren voor ZZP'ers wel gemakkelijker maken, en inzetten op coÃ¶peraties, om de positie van ZZP'ers te versterken. "},
	{name: "Libertarische Partij", position: "contra", explanation: "Hoewel wij de wijsheid van een verzekering tegen arbeidsongeschiktheid niet tegenspreken, vinden wij niet dat de ZZP-ers er verplicht moeten zijn eraan deel te nemen. Dit dient een weloverwogen keuze te zijn. "}
	]
},
{
	...
	parties: [
	{name: "SP", position: "pro", explanation: "Het schuldenstelsel dat vorig jaar voor studenten is ingevoerd zorgt ervoor dat jongere generaties met grote schulden hun loopbaan beginnen. Onderwijs is te belangrijk voor ons land om met financiÃ«le drempels te beperken en ontmoedigen. Wij moeten jongeren stimuleren, niet straffen, om door te leren. "},
	{name: "CDA", position: "pro", explanation: "Het leenstelsel vergroot de kansenongelijkheid van studenten en tast daarmee de toegankelijkheid van het hoger onderwijs aan. Sinds de introductie van het leenstelsel studeren er minder studenten dan voorheen, vooral onder kwetsbare groepen is de aanmelding minder. Iedereen moet kunnen studeren, ongeacht de portemonnee van zijn of haar ouders. Daarom voeren wij de basisbeurs weer in voor de bachelorfase, hiermee krijgt 80% van de studenten de basisbeurs weer terug."},
	{name: "ChristenUnie", position: "pro", explanation: "De ChristenUnie voert de basisbeurs weer in en zet een streep door het leenstelsel. Het leenstelsel is een te hoge financiÃ«le drempel tot hoger onderwijs en leidt tot kansenongelijkheid. Het is ook onwenselijk dat jonge mensen na hun studie met grote schulden de arbeidsmarkt en woningmarkt betreden."},
	{name: "Partij voor de Dieren", position: "pro", explanation: "Het leenstelsel voor studenten zadelt hen op met hoge kosten en zorgt ervoor dat de student na zijn of haar studie met een grote schuld zit opgescheept. Studeren moet voor iedereen toegankelijk blijven. Daarom willen wij dat het leenstelsel wordt afgeschaft en dat de basisbeurs terugkomt."},
	{name: "50Plus", position: "pro", explanation: "50PLUS is tegen het sociaal leenstelsel. Altijd geweest! De basisbeurs vormt een betere waarborg voor de toegankelijkheid van het hoger onderwijs voor alle groepen van de bevolking. 50PLUS vindt het onwenselijk om jonge mensen al zo vroeg in hun leven op te zadelen met (forse) schulden."},
	{name: "OndernemersPartij", position: "pro", explanation: "Dit is een bezuinigingsmaatregel die talent niet stimuleert."},
	{name: "DENK", position: "pro", explanation: "DENK wil dat het hoger onderwijs toegankelijk is voor iedereen, niet alleen voor mensen uit een gezin met een grote portemonnee. DENK wil niet dat wij onze kinderen opzadelen met een schuld, omdat ze studeren. Er mag geen boete staan op het ontplooien van talent. Daarom moet het leenstelsel verdwijnen. "},
	{name: "Nieuwe Wegen", position: "pro", explanation: "De toegankelijkheid van ons onderwijs moet voor iedereen gewaarborgd zijn en mag niet afhangen van de grootte van de portemonnee van je ouders. Als jongeren afhaken omdat de kosten te hoog worden, zijn we in Nederland op de verkeerde weg. We hebben juist iedereen nodig om ons land en onze economie met goede opleidingen voor iedereen sterker te maken. "},
	{name: "Forum voor Democratie", position: "pro", explanation: "Iedereen moet kunnen studeren, ongeacht de financiÃ«le situatie van de ouders."},
	{name: "De Burger Beweging", position: "pro", explanation: "Eens, studenten volpompen met schuld is niet wenslijk en nodig, daarnaast moet ook het les en collegegeld worden afgeschaft, zie Duitsland, Denemarken en nog meer landen in Europa. "},
	{name: "Vrijzinnige Partij", position: "pro", explanation: "Studeren zonder dat schulden gemaakt worden. Dan is voor de Vrijzinnige Partij het invoeren van de basisbeurs een eerste stap. Maar dat betekent ook extra bureaucratie door DUO en allerlei betuttelende regeltjes. Door voor iedereen het basisinkomen in te voeren, worden ook studenten weer vrij om zich te ontwikkelen en ontplooien zonder bureaucratie of studieschulden."},
	{name: "Piratenpartij", position: "pro", explanation: "De Piratenpartij vindt onderwijs een belangrijk burgerrecht, dat niet afhankelijk zou moeten zijn van je portemonnee. Door het leenstelsel zien steeds meer jongeren om financiÃ«le redenen af van onderwijs op het hoogste niveau."},
	{name: "Artikel 1", position: "pro", explanation: "Ook en juist binnen het onderwijs dienen gelijkwaardigheid en de mogelijkheid zichzelf te ontplooien prioriteit te zijn. Het huidige leenstelsel voldoet niet aan deze basisprincipes."},
	{name: "Lokaal in de Kamer", position: "pro", explanation: "Studiekeuze wordt nu mede bepaald door financiÃ«le situatie en niet door motivatie. Studeren moet weer toegankelijk zijn alle jongeren. "},
	{name: "VNL", position: "ambivalent", explanation: "Het leenstelsel hoeft niet te worden afgeschaft. Studeren is een investering in jezelf. "},
	{name: "VVD", position: "contra", explanation: "Dankzij het studievoorschot kunnen we honderden miljoenen extra investeren in de kwaliteit van het hoger onderwijs. Die vallen weg als de basisbeurs weer wordt ingevoerd. Er blijft een aanvullende beurs voor mensen met een laag inkomen. "},
	{name: "PvdA", position: "contra", explanation: "Iedereen moet kunnen studeren. Wie gestudeerd heeft gaat meer verdienen en mag dan ook gevraagd worden een deel terug te betalen. Dat doen we eerlijk en afhankelijk van je salaris. Dat geld gaat naar verbetering van de kwaliteit van het onderwijs in dienst van ons allemaal. Voor jongeren met ouders die het niet breed hebben bestaat de aanvullende beurs zodat niemand een studie hoeft te laten vanwege de kosten."},
	{name: "PVV", position: "contra", explanation: "Geen toelichting gegeven"},
	{name: "D66", position: "contra", explanation: "D66 heeft gezorgd voor meer investeringen in de kwaliteit van het hoger onderwijs en meer ruimte voor medezeggenschap. Hiervoor was het invoeren van het sociaal leenstelsel noodzakelijk. Om de toegankelijkheid van het hoger onderwijs te waarborgen is de aanvullende beurs met 100 euro verhoogd."},
	{name: "GroenLinks", position: "contra", explanation: "De toegankelijkheid van het hoger onderwijs staat voor GroenLinks voorop. Daarom willen wij het collegegeld halveren. Bovendien verhogen we de aanvullende beurs voor studenten uit kansarme gezinnen en maken we deze voor een ruimere groep beschikbaar."},
	{name: "SGP", position: "contra", explanation: "De SGP vindt dat financiÃ«le drempels geen belemmering mogen zijn voor het volgen van hoger onderwijs. Vooral de (lagere) middeninkomens zitten nu in de knel. De aanvullende beurs moet daarom uitgebreid worden."},
	{name: "Libertarische Partij", position: "contra", explanation: "Studeren is een investering in jezelf dat zichzelf terugbetaalt. Hiervoor hoeft er geen overheidsstudiebeurs te komen. Er zijn veel onderzoeken die aantonen dat hoge studiebeurzen de kosten van onderwijs opdrijven. Hiermee schiet je jezelf in de voet. "}
	]
}
];
...
var parties = [
	...
	{name: "50Plus", secular: true, size: 2},
